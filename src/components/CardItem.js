...
function CardItem({ title, setProgressBar, APIKEY, alertTodo }) {
  const [data, setData] = useState([
    ...
    {
      "ID": "53",
      "Link": "https://practice.geeksforgeeks.org/problems/non-repeating-character-1587115620/1?page=1&difficulty[]=-1&difficulty[]=0&status[]=unsolved&category[]=Strings&sortBy=submissions",
      "Title": "Non Repeating Character",
      "Status": "Done",
      "Level": "2",
      "Accuracy": "5",
      "Time": "13m 21s",
      "Code": "let st = Array.from(new Set(s))\n        for(let v of st){\n            let reg = new RegExp(v,'g')\n            let res = [...s.matchAll(reg)]\n            if(res.length==1) return v\n        }\n        return '$'",
      "Date": "1674150720414",
      "Score": "560"
    },
    {
      "ID": "54",
      "Link": "https://practice.geeksforgeeks.org/problems/non-repeating-element3958/1?page=1&sortBy=submissions&searchQuery=Non",
